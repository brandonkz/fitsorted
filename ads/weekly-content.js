...
(async () => {
  ...
  const buildSlides = (item) => {
    ...
    const macrosAvailable = (p > 0 || carbs > 0 || fat > 0);
    const s3style = `.lbl{font-size:26px;font-weight:700;color:rgba(255,255,255,0.4);letter-spacing:4px;text-transform:uppercase;margin-bottom:16px;margin-top:0;}.ttl{font-size:52px;font-weight:900;color:#fff;margin-bottom:36px;text-align:center;}.macros{display:flex;gap:20px;margin-bottom:36px;width:100%;}.mac{flex:1;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:20px;padding:26px 20px;text-align:center;}.mv{font-size:50px;font-weight:900;color:#fff;}.ml{font-size:19px;color:rgba(255,255,255,0.4);letter-spacing:2px;font-weight:600;margin-top:6px;}.verdict{background:${accent}18;border:1px solid ${accent}44;border-radius:20px;padding:28px 36px;margin-bottom:16px;font-size:30px;color:rgba(255,255,255,0.85);line-height:1.5;text-align:center;font-style:italic;}.kicker{font-size:24px;letter-spacing:3px;color:${accent};font-weight:800;text-transform:uppercase;margin-bottom:12px;}.big{font-size:72px;font-weight:900;color:#fff;letter-spacing:-1px;margin-bottom:10px;}.sub{font-size:28px;color:rgba(255,255,255,0.6);text-align:center;line-height:1.4;}`;
    const s3body = macrosAvailable
      ? `<div class="lbl">THE MACROS</div><div class="ttl">Full nutritional breakdown</div><div class="macros"><div class="mac"><div class="mv">${p}g</div><div class="ml">PROTEIN</div></div><div class="mac"><div class="mv">${carbs}g</div><div class="ml">CARBS</div></div><div class="mac"><div class="mv">${fat}g</div><div class="ml">FAT</div></div></div><div class="verdict">"${verdict}"</div>`
      : `<div class="kicker">KEY TAKEAWAY</div><div class="big">${isComp && item.saved ? item.saved : Math.round(cal*0.2)} cal saved</div><div class="sub">Small swaps add up fast. Calories are the only number that matters if the macros aren't listed.</div><div class="verdict">"Track it. Know it. Own it."</div>`;
